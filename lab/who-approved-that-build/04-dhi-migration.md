...
<rect x="134" y="40" width="118" height="44" rx="9" fill="#0b1533" stroke="#2563eb" stroke-width="3"/><text x="193.0" y="67" text-anchor="middle" font-size="13" font-weight="700" fill="#ffffff">BASE</text><text x="193.0" y="34" text-anchor="middle" font-size="10" font-weight="800" fill="#2563eb">▶ you are here</text>
...
> **Where you are on the road:** the **BASE** stage - the pivot. Every CVE you measured in
> Lab 1 traces back to a base image nobody in your organisation chose. Change where the image
> starts, and the numbers downstream change with it.
